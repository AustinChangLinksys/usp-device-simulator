...
class Record extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, Record_RecordType> _Record_RecordTypeByTag =
      {
    4: Record_RecordType.noSessionContext,
    5: Record_RecordType.sessionContext,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..oo(0, [4, 5, 9, 10, 11, 12, 13])
    ..aOS(1, _omitFieldNames ? '' : 'version')
    ..aOS(2, _omitFieldNames ? '' : 'toId')
    ..aOS(3, _omitFieldNames ? '' : 'fromId')
    ..aOM<NoSessionContextRecord>(4, _omitFieldNames ? '' : 'noSessionContext',
        subBuilder: NoSessionContextRecord.create)
    ..aOM<SessionContextRecord>(5, _omitFieldNames ? '' : 'sessionContext',
  ...
  @$pb.TagNumber(4)
  NoSessionContextRecord get noSessionContext => $_getN(3);
  @$pb.TagNumber(4)
  set noSessionContext(NoSessionContextRecord value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasNoSessionContext() => $_has(3);
  @$pb.TagNumber(4)
  void clearNoSessionContext() => $_clearField(4);
  @$pb.TagNumber(4)
  NoSessionContextRecord ensureNoSessionContext() => $_ensure(3);

  @$pb.TagNumber(5)
  SessionContextRecord get sessionContext => $_getN(4);
  @$pb.TagNumber(5)
  set sessionContext(SessionContextRecord value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasSessionContext() => $_has(4);
  @$pb.TagNumber(5)
  void clearSessionContext() => $_clearField(5);
  @$pb.TagNumber(5)
  SessionContextRecord ensureSessionContext() => $_ensure(4);

  @$pb.TagNumber(9)
  WebSocketConnectRecord get websocketConnect => $_getN(5);
  @$pb.TagNumber(9)
  set websocketConnect(WebSocketConnectRecord value) => $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasWebsocketConnect() => $_has(5);
  @$pb.TagNumber(9)
  void clearWebsocketConnect() => $_clearField(9);
  @$pb.TagNumber(9)
  WebSocketConnectRecord ensureWebsocketConnect() => $_ensure(5);

  @$pb.TagNumber(10)
  MQTTConnectRecord get mqttConnect => $_getN(6);
  @$pb.TagNumber(10)
  set mqttConnect(MQTTConnectRecord value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasMqttConnect() => $_has(6);
  @$pb.TagNumber(10)
  void clearMqttConnect() => $_clearField(10);
  @$pb.TagNumber(10)
  MQTTConnectRecord ensureMqttConnect() => $_ensure(6);

  @$pb.TagNumber(11)
  STOMPConnectRecord get stompConnect => $_getN(7);
  @$pb.TagNumber(11)
  set stompConnect(STOMPConnectRecord value) => $_setField(11, value);
  @$pb.TagNumber(11)
  $core.bool hasStompConnect() => $_has(7);
  @$pb.TagNumber(11)
  void clearStompConnect() => $_clearField(11);
  @$pb.TagNumber(11)
  STOMPConnectRecord ensureStompConnect() => $_ensure(7);

  @$pb.TagNumber(12)
  DisconnectRecord get disconnect => $_getN(8);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(12)
  DisconnectRecord ensureDisconnect() => $_ensure(8);

  @$pb.TagNumber(13)
  UDSConnectRecord get udsConnect => $_getN(9);
  @$pb.TagNumber(13)
  set udsConnect(UDSConnectRecord value) => $_setField(13, value);
  @$pb.TagNumber(13)
  $core.bool hasUdsConnect() => $_has(9);
  @$pb.TagNumber(13)
  void clearUdsConnect() => $_clearField(13);
  @$pb.TagNumber(13)
  UDSConnectRecord ensureUdsConnect() => $_ensure(9);
}
...
enum SessionContextRecord_Payload { payloadSecurity, payloadNoSecurity, notSet }
...
class SessionContextRecord extends $pb.GeneratedMessage {
  factory SessionContextRecord({
    ...
    $core.List<$core.int>? payloadSecurity,
    $core.List<$core.int>? payloadNoSecurity,
  }) {
    final result = create();
    ...
    if (payloadNoSecurity != null) result.payloadNoSecurity = payloadNoSecurity;
    return result;
  }
  ...
  static const $core.Map<$core.int, SessionContextRecord_Payload>
      _SessionContextRecord_PayloadByTag = {
    5: SessionContextRecord_Payload.payloadSecurity,
    6: SessionContextRecord_Payload.payloadNoSecurity,
    0: SessionContextRecord_Payload.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(
        ...
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.List<$core.int>>(
        5, _omitFieldNames ? '' : 'payloadSecurity', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(
        6, _omitFieldNames ? '' : 'payloadNoSecurity', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(5)
  @$pb.TagNumber(6)
  SessionContextRecord_Payload whichPayload() =>
      _SessionContextRecord_PayloadByTag[$_whichOneof(0)]!;
  @$pb.TagNumber(5)
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(5)
  $core.List<$core.int> get payloadSecurity => $_getN(4);
  @$pb.TagNumber(5)
  set payloadSecurity($core.List<$core.int> value) => $_setBytes(4, value);
  @$pb.TagNumber(5)
  $core.bool hasPayloadSecurity() => $_has(4);
  @$pb.TagNumber(5)
  void clearPayloadSecurity() => $_clearField(5);

  @$pb.TagNumber(6)
  $core.List<$core.int> get payloadNoSecurity => $_getN(5);
  @$pb.TagNumber(6)
  set payloadNoSecurity($core.List<$core.int> value) => $_setBytes(5, value);
  @$pb.TagNumber(6)
  $core.bool hasPayloadNoSecurity() => $_has(5);
  @$pb.TagNumber(6)
  void clearPayloadNoSecurity() => $_clearField(6);
}
