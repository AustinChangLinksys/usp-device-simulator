...
class UspPath {
  ...
  UspPath(this.segments, {this.hasWildcard = false, Map<String, String>? aliasFilter})
      : aliasFilter = aliasFilter ?? const {};

  /// Creates a new [UspPath] from a JSON map.
  factory UspPath.fromJson(Map<String, dynamic> json) => _$UspPathFromJson(json);
  ...
  factory UspPath.parse(String rawPath) {
    ...
    return UspPath(parsedSegments, hasWildcard: wildcardFound, aliasFilter: parsedAliasFilter);
  }
