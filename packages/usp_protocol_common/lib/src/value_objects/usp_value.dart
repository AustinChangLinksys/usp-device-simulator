...
class UspValue<T> {
  ...
  factory UspValue.fromJson(Map<String, dynamic> json, T Function(Object? json) fromJsonT) => _$UspValueFromJson(json, fromJsonT);

  /// Converts this [UspValue] to a JSON map.
  Map<String, dynamic> toJson(Object? Function(T value) toJsonT) => _$UspValueToJson(this, toJsonT);
