...
void main() {
  group('UspRecordHelper', () {
    ...
    test(
      'unwrap should not throw UspException for PLAINTEXT security but missing noSessionContext',
      () {
        ...
        // Ensure that we fallback to empty/raw without crashing UspException directly on missing noSessionContext
        expect(
