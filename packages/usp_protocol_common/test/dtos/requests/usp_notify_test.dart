  ...
  group('UspNotify DTOs', () {
    group('UspValueChangeNotify', () {
      ...
      test('should support value equality', () {
        ...
        final notify1 = UspValueChangeNotify(paramPath: path1, paramValue: 'Active');
        final notify2 = UspValueChangeNotify(paramPath: path1, paramValue: 'Active');
        final notify3 = UspValueChangeNotify(paramPath: path1, paramValue: 'Inactive');
    ...
    group('UspObjectCreationNotify', () {
      ...
      test('should support value equality', () {
        ...
        final notify1 = UspObjectCreationNotify(objPath: path1, uniqueKeys: {'ID': '1'});
        final notify2 = UspObjectCreationNotify(objPath: path1, uniqueKeys: {'ID': '1'});
        final notify3 = UspObjectCreationNotify(objPath: path1, uniqueKeys: {'ID': '2'});
    ...
    group('UspObjectDeletionNotify', () {
      ...
      test('should support value equality', () {
        ...
        final notify3 = UspObjectDeletionNotify(objPath: UspPath.parse('Device.LocalAgent.Endpoint.2'));
    ...
    group('UspOperationCompleteNotify', () {
      ...
      test('should support value equality', () {
        ...
        final notify1 = UspOperationCompleteNotify(
            objPath: path1, commandName: 'Reboot', commandKey: 'cmd1');
        final notify2 = UspOperationCompleteNotify(
            objPath: path1, commandName: 'Reboot', commandKey: 'cmd1');
        final notify3 = UspOperationCompleteNotify(
            objPath: path1, commandName: 'Reboot', commandKey: 'cmd2');
    ...
    group('UspOnBoardRequestNotify', () {
      ...
      test('should support value equality', () {
        final notify1 = UspOnBoardRequestNotify(
            oui: '1', productClass: 'PC', serialNumber: 'SN', agentProtocolVersions: 'V1');
        final notify2 = UspOnBoardRequestNotify(
            oui: '1', productClass: 'PC', serialNumber: 'SN', agentProtocolVersions: 'V1');
        final notify3 = UspOnBoardRequestNotify(
            oui: '2', productClass: 'PC', serialNumber: 'SN', agentProtocolVersions: 'V1');
