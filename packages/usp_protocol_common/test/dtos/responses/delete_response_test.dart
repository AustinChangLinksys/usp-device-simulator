...
void main() {
  group('UspDeleteResponse', () {
    ...
    test('should support value equality', () {
      ...
      final response1 = UspDeleteResponse(deletedPaths: deleted1, errors: errors1);

      final deleted2 = [UspPath.parse('Device.WiFi.AccessPoint.1')];
      final errors2 = [UspException(1, 'Error')];
      final response2 = UspDeleteResponse(deletedPaths: deleted2, errors: errors2);

      final deleted3 = [UspPath.parse('Device.LocalAgent.1')];
      final errors3 = [UspException(2, 'Different Error')];
      final response3 = UspDeleteResponse(deletedPaths: deleted3, errors: errors3);
