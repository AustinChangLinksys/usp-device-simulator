...
void main() {
  group('UspGetResponse', () {
    test('should correctly assign properties', () {
      final results = {
        UspPath.parse('Device.DeviceInfo.SerialNumber'): UspValue('12345', UspValueType.string),
      };
    ...
    test('should support value equality', () {
      ...
      final results3 = {
        UspPath.parse('Device.DeviceInfo.ModelName'): UspValue('ABC-100', UspValueType.string),
      };
