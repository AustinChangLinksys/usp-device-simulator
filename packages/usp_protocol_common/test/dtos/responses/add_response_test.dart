...
void main() {
  group('UspAddResponse', () {
    test('should correctly assign properties', () {
      ...
      final errors = [
        UspException(1, 'Failed to create another object'),
      ];
    ...
    test('should support value equality', () {
      final created1 = [UspCreatedObject(UspPath.parse('Device.WiFi.AccessPoint.1'))];
      final errors1 = [UspException(1, 'Error')];
      final response1 = UspAddResponse(createdObjects: created1, errors: errors1);

      final created2 = [UspCreatedObject(UspPath.parse('Device.WiFi.AccessPoint.1'))];
      final errors2 = [UspException(1, 'Error')];
      final response2 = UspAddResponse(createdObjects: created2, errors: errors2);

      final created3 = [UspCreatedObject(UspPath.parse('Device.LocalAgent.1'))];
      final errors3 = [UspException(2, 'Different Error')];
      final response3 = UspAddResponse(createdObjects: created3, errors: errors3);
